...
use ferrocarril_core::{tensor::Tensor, Forward, FerroError, LoadWeightsBinary};
...
impl LoadWeightsBinary for SourceModuleHnNSF {
    fn load_weights_binary(
        ...
        // Load linear layer weights for harmonic mixing
        self.linear.load_weights_binary(loader, component, &format!("{}.l_linear", prefix))?;
        Ok(())
    }
}